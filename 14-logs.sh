...
if [ $? -ne 0 ]
then
    echo "MySQL is not installed..... is about to install it" | tee -a $LOG_FILE 
...
if [ $? -ne 0 ]
then
    echo "python3 is not installed..... is about to install it" | tee -a $LOG_FILE 
...
if [ $? -ne 0 ]
then
    echo "nginx is not installed..... is about to install it" | tee -a $LOG_FILE 
